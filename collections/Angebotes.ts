...
// Angebot
import { Angebot } from '../blocks/Angebot/Config';
import { Type as AngebotType } from '../blocks/Angebot/Component';


export type Layout = CallToActionType | ContentType | ImageType | AngebotType
